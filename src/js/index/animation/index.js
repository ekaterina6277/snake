const  animationStars = {
    ...
    init() {
        ...
        this.settings.focalLenght = this.settings.canvasElement.width * 2;
    ...
    drawStars() {
        ...
        for (let i = 0; i < this.settings.numberStars; i++) {
            ...
            this.settings.pixelX = (this.settings.star.x - this.settings.centerX) * (this.settings.focalLenght / this.settings.star.z);
            this.settings.pixelX += this.settings.centerX;

            this.settings.pixelY = (this.settings.star.y - this.settings.centerY) * (this.settings.focalLenght / this.settings.star.z);
            this.settings.pixelY = this.settings.pixelY + this.settings.centerY;

            this.settings.pixelRadius = this.settings.focalLenght / this.settings.star.z;
            ...
            this.settings.canvasContext.fillStyle = `rgba(209, 255, 255, ${this.settings.star.o})`
        }
